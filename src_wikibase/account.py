...
from src_wikibase.account_usernames_passwords import *
...
login_wikibase = wbi_login.Login(user=WDUSER_wikibase, password=WDPASS_wikibase, mediawiki_api_url=wikibase_api_url)
